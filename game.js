...
function checkAnswer(currentLevel){
  ...
  if(gamePattern[currentLevel] === userClickedPattern[currentLevel]){
    ...
    // In the styles.css file, there is a class called "game-over", apply this class to the body of the website when
...
function nextSequence(){
  ...
  // Add the new randomChosenColour generated aboveto the end of the gamePattern.
...
function animatePress(currentColour){
  ...
  // removing after 100 milliseconds
  setTimeout(function(){
